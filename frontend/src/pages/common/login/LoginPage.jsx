...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Σφάλμα σύνδεσης με το διακομιστή. Βεβαιωθείτε ότι το JSON Server είναι ενεργό.');
    }
  };
      ...
      <div className="login-page">
        ...
        <div className="login-container">
          ...
          <div className="login-signup">
            ...
            <p><Link to={ROUTES.owner.register} className="login-owner-signup-link">Κάντε εγγραφή ως Ιδιοκτήτης </Link> </p>
            <p><Link to={ROUTES.vet.register} className="login-vet-signup-link">Κάντε εγγραφή ως Κτηνίατρος</Link></p>
          </div>
        </div>
      </div>
    </PageLayout>
