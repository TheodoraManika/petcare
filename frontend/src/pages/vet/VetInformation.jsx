...
const VetInformation = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: 'Δηλώστε άμεσα την απώλεια, εύρεση, μετακίνηση, υιοθεσία και ανταλλαγή ενός κατοικιδίου. Οι δηλώσεις εμφανίζονται αυτόματα στους ιδιοκτήτες τους οποίους αφορούν.',
      features: [
        'Ιστορικό δηλώσεων',
    ...
    },
    {
      ...
      description: 'Διαχειριστείτε τα ραντεβού σας και ενημερώθείτε άμεσα για την κατάσταση τους. Εγκρίνετε ή απορρίπτε εύκολα ένα ραντεβού',
      features: [
        'Κατάσταση: Ενεργές, Επιβεβαιωμένο, Ακυρωμένο, Ολοκληρωμένο',
  ...
  return (
    <PageLayout title="Πληροφορίες για Κτηνιάτρους">
      <div className="vet-information-page">
        <div className="vet-information-header">
          <h1>Πληροφορίες για Κτηνιάτρους</h1>
        ...
        <div className="vet-contents-box">
          ...
          <ul className="vet-contents-links">
            ...
            <li><a href="#faq-3">Πώς μπορώ να δώ τις αξιολογήσεις που μου έχουν κάνει οι χρήστες;</a></li>
            <li><a href="#faq-4">Πώς μπορώ να δώ τις δηλώσεις και τις ιατρικές πράξεις που έχω κάνει;</a></li>
            ...
            <li><a href="#faq-9">Πώς μπορώ να κάνω καταγραφή ενός ζώου;</a></li>
        ...
        <div className="vet-faq-container">
          ...
          <div className="vet-faq-section" id="faq-1">
            ...
            <div className="vet-steps-container">
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Επιλέξτε το κουμπί "Εγγραφή" που βρίσκεται πάνω δεξιά. Από τη λίστα που θα εμφανιστεί, επιλέξτε "Ας κτηνίατρος".</p>
                </div>
              </div>
            ...
            <div className="vet-info-note">
              <strong>Σημείωση!</strong> Για να δημιουργήσετε λογαριασμό ως κτηνίατρης, θα χρειαστείτε τον Αριθμό Άδειας Ασκήσεως Επαγγέλματος σας. Συνιστάται να χρησιμοποιήσετε την επαγγελματική σας διεύθυνση ηλεκτρονικού ταχυδρομείου (email).
            </div>
          </div>
        </div>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Το μενού βρίσκεται πάνω δεξιά στη γραμμή πλοήγησης. Μέσα σε αυτό υπάρχουν όλες οι ενέργειες που μπορούν να κάνουν οι κτηνίατροι.</p>
                </div>
              </div>
          ...
          <div className="vet-faq-section" id="faq-3">
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  <h3>Επιλέξτε "Μενού"</h3>
                  <p>Το μενού βρίσκεται πάνω δεξιά ή γραμμή πλοήγησης. Μέσα σε αυτό υπάρχουν όλες οι ενέργειες που μπορούν να κάνουν οι κτηνίατροι.</p>
                </div>
              </div>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Εδώ εμφανίζονται όλα τα ραντεβού σας και η κατάσταση τους (Εκκρεμή, Επιβεβαιωμένα, Ολοκληρωμένα, Ακυρωμένα).</p>
                </div>
              </div>
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Τα ραντεβού που είναι στην κατάσταση Εκκρεμή χρειάζονται έγκριση ή απόρριψη από εσάς.</p>
                  <ul className="vet-bullet-list">
                    <li>Αν κάνετε προσβολή των ραντεβού σε μορφή λίστας ή Ημερολογίου (Ανά ημέρα ή εβδομάδα), κάντε κλικ στο ραντεβού που θέλετε να εγκρίνετε ή να απορρίψετε. Θα εμφανιστούν οι Λειτουργίες του. Πατήστε το κουμπί "Απόρριψη" ή "Επιβεβαίωση" αντίστοιχα.</li>
                    <li>Αν κάνετε προβολή των ραντεβού σε μορφή ημερολογίου ανά ημέρα, κάντε κλικ στο ραντεβού που θέλετε να εγκρίνετε ή να απορρίψετε. Θα εμφανιστούν οι λειτουργίες του. Πατήστε το κουμπί "Απόρριψη" ή "Επιβεβαίωση" αντίστοιχα.</li>
                    <li>Αν κάνετε προβολή των ραντεβού σε μορφή ημερολογίου ανά ημέρα, κάντε κλικ στο ραντεβού που θέλετε να εγκρίνετε ή να απορρίψετε. Θα εμφανιστούν οι λειτουργίες του. Πατήστε το κουμπί "Απόρριψη" ή "Επιβεβαίωση" αντίστοιχα.</li>
                  </ul>
                </div>
              </div>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Εδώ εμφανίζεται ένα ημερολόγιο με όλες τις ώρες και μέρες που δέχεσαι ραντεβού. Για να προσθέσετε ένα καινούριο, επιλέξτε ώρα, ημέρα και υπηρεσία και πατήστε το κουμπί "Προσθήκη". Το χρονικό παράθυρο που όρισες θα εμφανιστεί στο ημερολόγιο αυτόματα. Αν θέλετε να κάνετε ακύρωση κάποιου χρονικού παραθύρου, ενημερώστε το και πατήστε το εικονίδιο του κώδικα δίπλα από αυτό.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="vet-faq-container">
          ...
          <div className="vet-faq-section" id="faq-7">
            <h2>Πώς μπορώ να κάνω δήλωση υιοθεσίας, μετάβασης ή αναδοχής κατοικιδίου;</h2>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Συμπληρώστε όλα τα πεδία στη φόρμα της δήλωσης. Πατήστε το κουμπί "Υποβολή Δήλωσης" αν είστε έτοιμοι να υποβάλλετε η δήλωση θα εμφανιστεί αυτόματα στο προφίλ των ιδιοκτητών που τους αφορά. Πατήστε το κουμπί "Ακύρωση" αν δε θέλετε να υποβάλλετε τη δήλωση. Προσοχή, η δήλωση θα χαθεί.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="vet-faq-section" id="faq-8">
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                <div className="vet-step-number">2</div>
                <div className="vet-step-content">
                  <h3>Επιλέξτε <strong>Κτηνίατρος</strong></h3>
                  <p>Βρίσκεται πάνω και δεξιά δεξιά. Από τη λίστα που θα ανοίξει, επιλέξτε "Το Προφίλ μου".</p>
                </div>
              </div>
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Πατήστε το κουμπί "Αποθήκευση" ώστε να αποθηκευτούν οι αλλαγές που κάνατε και να ενημερωθεί το προφίλ σας. Αν δε θέλετε να αποθηκεύσετε τις αλλαγές, πατήστε το κουμπί "Ακύρωση".</p>
                </div>
              </div>
            </div>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Πατήστε το κουμπί "Διαγραφή Λογαριασμού" και στον σας ζητηθεί επιβεβαίωση πατήστε το κουμπί Διαγραφή.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="vet-faq-section" id="faq-9">
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  <h3>Συμπληρώστε τη δήλωση</h3>
                  <p>Επιλέξτε "Δήλωση Εύρεσης". Συμπληρώστε τη φόρμα και πατήστε "Ορίστική Υποβολή" για την υποβασία ή "Ακύρωση" αν δε θέλετε να υποβάλλετε.</p>
                </div>
              </div>
            </div>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  <h3>Συμπληρώστε τη δήλωση</h3>
                  <p>Επιλέξτε "Δήλωση Απώλειας". Συμπληρώστε τη φόρμα και πατήστε "Ορίστική Υποβολή" για την υποβασία ή "Ακύρωση" αν δε θέλετε να υποβάλλετε.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="vet-steps-container">
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Επιλέξτε τα κατάλληλα φίλτρα με βάση την αναζήτηση που θέλετε να κάνετε. Αν θέλετε να δείτε λεπτομέρειες κάποιου κατοικιδίου πατήστε το κουμπί "Προβολή Λεπτομερειών".</p>
                </div>
              </div>
              ...
              <div className="vet-step">
                ...
                <div className="vet-step-content">
                  ...
                  <p>Πατήστε το κουμπί "Το Βρήκα - Δήλωση Εύρεσης" από τις λεπτομέρειες του κατοικιδίου και συμπληρώστε τη φόρμα.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="vet-related-info">
          ...
          <ul className="vet-checklist">
            ...
            <li>
              <SquareCheckBig size={24} className="vet-checklist-icon" />
              <span>Δηλώσεις μεταβίβασης, υιοθεσίας και αναδοχής μπορούν να γίνουν μόνο από κτηνιάτρους και όχι από τους ιδιοκτήτες</span>
            </li>
          </ul>
        </div>
